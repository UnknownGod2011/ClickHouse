...
LEFT JOIN {database}.continuity_baselines AS b
...
def editorial_retrieval_sql(
    c: EditorialConstraints,
    *,
    database: str = "takekeeper",
) -> str:
    database = _database_identifier(database)
...
INNER JOIN {database}.observations AS o
